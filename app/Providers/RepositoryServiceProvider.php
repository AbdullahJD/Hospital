...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(\App\Interfaces\Dashboard_Ray_Employee\InvoicesRepositoryInterface::class, 'App\Repository\Dashboard_Ray_Employee\InvoicesRepository');

        //Dashboard_Laboratorie_Employee
        $this->app->bind(\App\Interfaces\Dashboard_Laboratorie_Employee\InvoicesRepositoryInterface::class,
