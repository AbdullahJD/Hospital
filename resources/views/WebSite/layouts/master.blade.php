...
<div class="page-wrapper {{ LaravelLocalization::getCurrentLocale() ==='ar' ? 'rtl': ''}}">
    ...
    <header class="main-header header-style-three">
        ...
        <div class="header-upper">
            <div class="inner-container clearfix">
                ...
                <div class="logo-outer">
                    <div class="logo"><a href="index.html"><img src="{{URL::asset('WebSite/images/logo-3.png')}}" alt="" title=""></a></div>
                </div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" class="img-responsive"><img src="{{URL::asset('WebSite/images/logo-small.png')}}" alt="" title=""></a>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{URL::asset('WebSite/images/nav-logo.png')}}" alt="" title=""></a></div>
            ...
            <div class="sidebar-textwidget">
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        <div class="logo">
                            <a href="index.html"><img src="{{URL::asset('WebSite/images/logo-3.png')}}" alt=""/></a>
                        </div>
