                ...
                <div class="card-body">
                    <form action="{{route('Patients.store')}}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="exampleInputEmail1">{{ trans('doctors.password') }}</label>
                                <input name="password" type="password" value="{{old('password')}}" class="form-control @error('password') is-invalid @enderror" required>
                            </div>
                        </div>
                        <br>
                        <div class="row">
